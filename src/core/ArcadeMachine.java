...
public class ArcadeMachine {
     ...
     */
    public static double runOneGame(String game_file, String level_file, boolean visuals, String agentName,
            String actionFile, int randomSeed, boolean isHuman) {
     ...
     * @param level_file file with the level to be played.
     * @param visuals    true to show the graphics, false otherwise.
     * @param actionFile name of the file where the actions of this player, for this
     *                   game, must be read from.
     */
    public static double replayGame(String game_file, String level_file, boolean visuals, String actionFile) {
        ...
        // Second, create the player. Note: null as action_file and -1 as sampleRandom
        // seed
        ...
        // Finally, when the game is over, we need to tear the player down. Actually in
        // this case this might never do anything.
        if (!ArcadeMachine.tearPlayerDown(toPlay, player))
            return toPlay.handleResult();
    ...
    public static void runGames(String game_file, String[] level_files, int level_times, String agentName,
        ...
        for (String level_file : level_files) {
            ...
            for (int i = 0; i < level_times; ++i) {
                ...
                // Create the player.
                AbstractPlayer player = ArcadeMachine.createPlayer(agentName, filename, toPlay.getObservation(),
                        randomSeed);
                ...
                // Finally, when the game is over, we need to tear the player down.
                if (player != null)
                    ArcadeMachine.tearPlayerDown(toPlay, player);
